...
export const Product = () => {
    return <section className="text-gray-700 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-10 object-cover object-center rounded"
                     src="https://images.unsplash.com/photo-1607582544644-f1da2a004994?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1351&q=80" />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h2 className="text-sm title-font text-gray-500 tracking-widest">John Doe</h2>
                        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Instagram Story</h1>
